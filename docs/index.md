...
first `.ps1` script to production-grade automation tooling — with runnable
...
| [Level 3 · Advanced](level-3/index.md) | Modules, DSC, security, performance | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | Production automation, DevOps & publishing | 9 topics + 1 capstone |

## How to use this site

- Work through each level in order — later modules assume earlier ones.
- Every topic page has runnable code snippets — copy them into a local `.ps1`
  file and run with `pwsh`, or paste into your terminal.
